...
router.route('/category').get(CategoryController.getCategory).post(userMiddleware.IsUserLoggeIn,userMiddleware.accessTo(Role.Admin),CategoryController.addCategory)
